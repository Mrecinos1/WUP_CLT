...
The graph is looking more symmetrical, because now we are using 25 samples at a time which gives us more chances or opinions discrepancies. And the standard deviation is decreasing as expected because we are dividing by a larger number. In this case it's the square root of 25.And it's closer to our expected value, which is 8.373430402.
...
The graph is looking more symmetrical, because now we are using 36 samples at a time which gives us more chances or opinions discrepancies. And the standard deviation is decreasing as expected because we are dividing by a larger number. In this case it's the square root of 36.And it's closer to our expected value, which is 6.977858668. This graph, in addition to the previous ones, demonstrates the central limit theorem by showing less standard deviation as we increase the sample size. 
